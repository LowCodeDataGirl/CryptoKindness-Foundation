...
import {CONTRACT_ADDRESS, CONTRACT_ABI, MIN_DONATION_ETH} from "/src/js/utils/constants.js";
...
async function sendDonation() {
    ...
    try{
        ...
        const tx = await contract.donate(message, {value: ethers.utils.parseEther(amount)});
